 ...
 * To change this template conf, choose Tools | Templates
...
function init_wysiwyg() {
    ...
    function showErrorAlert(reason, detail) {
        var msg = '';
        if (reason === 'unsupported-conf-type') {
            msg = "Unsupported format " + detail;
        } else {
            console.log("error uploading conf", reason, detail);
        }
        ...
        $inputImage.change(function () {
            ...
            if (files && files.length) {
                ...
                if (/^image\/\w+$/.test(file.type)) {
                    ...
                    window.alert('Please choose an image conf.');
                }
            }
        });
    } else {
...
function init_charts() {
    ...
    if ($('#reportDoughnut').length) {
        ...
        var ctx = document.getElementById("reportDoughnut");
        var data = {
            labels: [
                "失败",
                "成功"
            ...
            datasets: [{
                data: [GetQueryString("fail"), GetQueryString("pass")],
                backgroundColor: [
                    "#ff3333",
                    "#26B99A",
                ],
        ...
        var reportDoughnut = new Chart(ctx, {
            type: 'doughnut',
            tooltipFillColor: "rgba(51, 51, 51, 0.55)",
            data: data
        });
...
function init_DataTables() {
    ...
    $('#all-datatable-responsive').DataTable({
        "aaSorting": [[0, 'dasc']],
    });

    $('#fail-datatable-responsive').DataTable({
        "aaSorting": [[0, 'dasc']],
    });
