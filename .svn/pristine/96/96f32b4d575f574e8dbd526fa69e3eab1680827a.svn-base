    ...
    var _saveAs = (function (view) {
        ...
        var
            ...
            , revoke = function (file) {
                ...
                /* // Take note W3C:
                 var
                 uri = typeof conf === "string" ? conf : conf.toURL()
                 , revoker = function(evt) {
                 // idealy DownloadFinishedEvent.data would be the URL requested
                 if (evt.data === uri) {
                 if (typeof conf === "string") { // conf is an object URL
                 get_URL().revokeObjectURL(conf);
                 } else { // conf is a File
                 conf.remove();
                 }
                 }
...
// since this file can be loaded before Button's core!
    ...
    /**
     * Get the conf name for an exported conf.
     *
     * @param {object}    config Button configuration
     * @param {boolean} incExtension Include the conf name extension
     */
    ...
    /**
     * Recursively add XML files from an object's structure to a ZIP conf. This
     * allows the XSLX conf to be easily defined with an object's structure matching
     * the files structure.
     *
