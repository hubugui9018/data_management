...
// you may not use this conf except in compliance with the License.
...
(function () {
    ...
    var prettyPrint = (function () {
         ...
         * conf that came with this source.  At a minimum, the lexer should work on a
         ...
         * <p>
         * Usage: <ol>
         * <li> include this source conf in an html page via
         ...
         * starts with "lang-" followed by a conf extension, specifies the conf type.
         * See the "lang-*.js" files in this directory for code that implements
         * per-language conf handlers.
         * <p>
         * Change log:<br>
         * cbeust, 2006/08/22
         * <blockquote>
       ...
       * }</pre>
            ...
            /** Maps language-specific conf extensions to handlers. */
            var langHandlerRegistry = {};

            /** Register a language handler for the given conf extensions.
